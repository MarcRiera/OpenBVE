...
{
	internal class PanelParser
	{
		internal readonly Plugin Plugin;

		internal PanelParser(Plugin plugin)
		{
			Plugin = plugin;
		}
										...
										switch (Key.ToLowerInvariant()) {
											...
											case "daytimeimage":
												...
												if (Path.ContainsInvalidChars(Value)) {
													...
													PanelDaytimeImage = Path.CombineFile(TrainPath, "Panel/" + Value);
											...
											case "nighttimeimage":
												...
												if (Path.ContainsInvalidChars(Value)) {
													...
													PanelNighttimeImage = Path.CombineFile(TrainPath, "Panel/" + Value);
											...
											switch (Key.ToLowerInvariant()) {
												...
												case "daytimeimage":
													...
													if (Path.ContainsInvalidChars(Value)) {
														...
														DaytimeImage = Path.CombineFile(TrainPath, "Panel/" + Value);
												...
												case "nighttimeimage":
													...
													if (Path.ContainsInvalidChars(Value)) {
														...
														NighttimeImage = Path.CombineFile(TrainPath, "Panel/" + Value);
		...
		internal string GetStackLanguageFromSubject(AbstractTrain Train, string Subject, string ErrorLocation) {
			...
			switch (Subject.ToLowerInvariant()) {
				case "am":
					Code = "accelerationmotor 250 *";
					break;
				case "amabs":
					Code = "accelerationmotor abs 250 *";
					break;
				case "true":
					Code = "1";
					break;
